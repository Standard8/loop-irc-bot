...
STANDUP_TIME_3 = '00 9 * * 1,4' # M,Th 09:00
W_STANDUP_TIME_1 = '05 9 * * 3' # W 09:05
W_STANDUP_TIME_2 = '13 9 * * 3' # W 09:13
W_STANDUP_TIME_3 = '15 9 * * 3' # W 09:15
...
module.exports = (robot) ->
  standup1 = new cronJob STANDUP_TIME_1,
    ->
      robot.messageRoom ROOM, "Standard8: NiKo`: tOkeshu: dmose: flo-retina: RT: alexis: Standup in 10 mins"
    null
    true
    TIMEZONE
  ...
  standup2 = new cronJob STANDUP_TIME_2,
    ->
      robot.messageRoom ROOM, "Standard8: NiKo`: tOkeshu: dmose: flo-retina: RT: alexis: Standup in 2 mins"
  ...
  standup3 = new cronJob STANDUP_TIME_3,
    ->
      robot.messageRoom ROOM, "Standard8: NiKo`: tOkeshu: dmose: flo-retina: RT: alexis: Standup now!"
    null
    true
    TIMEZONE
  ...
  standup3 = new cronJob W_STANDUP_TIME_3,
    ->
      robot.messageRoom ROOM, "Standard8: NiKo`: tOkeshu: dmose: flo-retina: RT: alexis: Standup now!"
    null
    true
