...
module.exports = (robot) ->
  standup1 = new cronJob STANDUP_TIME_1,
    ->
      robot.messageRoom ROOM, "Standard8: NiKo`: tOkeshu: dmose: mreavy: shell: mikedeboer: jaws: gavin: Standup in 10 mins"
    null
    true
    TIMEZONE
  ...
  standup2 = new cronJob STANDUP_TIME_2,
    ->
      robot.messageRoom ROOM, "Standard8: NiKo`: tOkeshu: dmose: mreavy: shell: mikedeboer: jaws: gavin: Standup in 2 mins"
  ...
  standup3 = new cronJob STANDUP_TIME_3,
    ->
      robot.messageRoom ROOM, "Standard8: NiKo`: tOkeshu: dmose: mreavy: shell: mikedeboer: jaws: gavin: Standup now!"
    null
    true
    TIMEZONE
